        ...
        <>
            <div className="rightHeader">
                <div className="bgLiner">
                    <h1 className='text-white rightHederH1 d-inline-block pt-5 pb-3 ps-5'>Right Sidebar Page</h1>
                    <p className='text-white ps-5'>Home / <a className='d-inline-block rightHederp'>Right Sidebar Page</a></p>
                </div>
            </div>
            <div className="rightContainer">
                <div className="row justify-content-center">
                    <div className="col-md-9">
                        <h1 className='rightContainerH1'>This is a right sidebar page</h1>
            ...
            {/* <div className="demo">
                <img src="./assets/morePages/rig.jpg" alt="" width={'300px'} height={'200px'} />
                <div className="res">
